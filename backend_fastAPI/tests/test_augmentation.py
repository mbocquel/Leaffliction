...
class TestAugmentation(unittest.TestCase):
    ...
    def test_rotating(self):
        ...
        expected_rot = np.array(
            Image.open("img_for_test/Augmentation/expected/rotated.png")
        )
    ...
    def test_flip(self):
        """Test the Flip"""
        expected_fliped = np.array(
            Image.open("img_for_test/Augmentation/expected/fliped.png")
        )
    ...
    def test_blur(self):
        ...
        expected_blur = np.array(
            Image.open("img_for_test/Augmentation/expected/blured.png")
        )
    ...
    def test_illumination(self):
        ...
        expected_illum = np.array(
            Image.open("img_for_test/Augmentation/expected/illuminated.png")
        )
        ...
        self.assertTrue(
            np.array_equal(np.array(self.aug.illuminate_img(illum_level=1, save=False)), np.array(self.img))
        )

    def test_scaling(self):
        """Test the scaling"""
        expected_scal = np.array(
            Image.open("img_for_test/Augmentation/expected/scaled.png")
        )
    ...
    def test_contrast(self):
        """Test the contrast"""
        expected_contr = np.array(
            Image.open("img_for_test/Augmentation/expected/contrasted.png")
        )
        ...
        self.assertTrue(
            np.array_equal(
                np.array(self.aug.increase_contrast(cont_factor=1, save=False)), np.array(self.img)
            )
        )
